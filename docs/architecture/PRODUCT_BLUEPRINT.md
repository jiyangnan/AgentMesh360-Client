...
| 桌面产品外壳 | **身份外壳、Agent 首页、Provider/Package/客户端设置和 Job Agent 固定 Main Session 文本对话第一切片已实现** | 下一步将同一 Host-owned Session 解析、安全历史投影和重连撤权通路扩展到 LectureCast、Deploy 与动态 Agent；Harness 交互/审批、活动、产物和垂直工作区继续后置 |
