...
| 动态 Agent Package | **H0/H1、H2a1、H2a2、H2b0、H2b1a、H2b1b1、H2b1b2、H2b1c 已通过自主测试和 Kimi 交叉测试** | H2b1c 已加入 Host-owned 双文档只读 Fetcher、固定生产 HTTPS origin、禁重定向/凭据/query、响应上限、持久 ETag/Last-Modified、304 重新验签、last-known-good 退化与 Package Status 脱敏状态；state.db 升至 v10。生产 endpoint/root/bundle、Artifact/Envelope 下载、安装 mutation、权限 UI、orphan 清理与宿主 Skill 安装仍关闭 |
