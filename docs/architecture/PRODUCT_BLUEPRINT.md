...
| 动态 Agent Package | **H0/H1 至 H2d4 已通过自主验证与 Kimi 独立交叉测试；P1 R6 本地基线、P2 preflight 与 P2 E0 测试 key 技术执行已完成** | H2d4 已在 Artifact/Envelope 前 bounded fetch Release Manifest，核对 Registry SHA、canonical strict 文档、Client/Host projection 与 H1 metadata。P1 已有 Release Event、证据模板、静态扫描、事故 Runbook 与 E0 tabletop；P2 已有严格 preflight/receipt Schema、隔离 runner、16 场景与销毁证据。生产 Root、Publisher Bundle、endpoint、上传和发布仍关闭，生产启用前仍须关闭适用的 R0/R1/R2/R3/R5/R6 |
